...
public class HechosOutputDto {
    ...
    public HechosOutputDto(Long idHecho, String titulo, String descripcion, String categoria,
            ContenidoMultimedia contenidoMultimedia, Double latitud, Double longitud, LocalDate fechaAcontecimiento,
            LocalDate fechaCarga, List<Etiqueta> etiquetas, List<SolicitudEliminacion> solicitudes,
    ...
    public static HechosOutputDto fromModel(Hecho h) {
        ...
        dto.setHoraAcontecimiento(h.getHoraAcontecimiento());
